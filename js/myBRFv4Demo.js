//
// Namespace: brfv4Manager structures these examples.
//

var brfv4Instance = {

	appId: "com.augemented.web.demo", // Choose your own app id. 8 chars minimum.
...
//
// function to detect which version of brfv4 is to be loaded
//
...
// 
// Entry point for the brfv4Instance
// 
brfv4Instance.start = () => {

    brfv4Instance.loader.preload(librariesToPreload, function() {

      brfv4Instance.init("webcam");
...
brfv4Instance.trace = function(msg, error) {
...
(function () {
  ...
  var loader = brfv4Instance.loader;
