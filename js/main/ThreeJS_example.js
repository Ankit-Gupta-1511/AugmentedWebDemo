(function exampleCode() {
	...
	var t3d = brfv4Instance.drawing3d.t3d;
	...
	brfv4Instance.dom.updateCodeSnippet(exampleCode + "");

	brfv4Instance.dom.updateHeadline("BRFv4 - advanced - face_tracking - ThreeJS example.\n" +
